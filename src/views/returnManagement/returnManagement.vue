  ...
  <div class="app-container calendar-list-container">
    ...
    <div class="return-box">
      <el-form :model="form"
        ...
        <el-row>
          <el-col :span="10">
            <el-form-item label="固定资产编号 或 流水号"
                          prop="returnId">
          ...
          <el-col :span="4"
            ...
            <el-button style="width:90px;"
                       type="primary"
                       @click="handleReturn('returnForm')">归 还
            </el-button>
          </el-col>
        </el-row>
      </el-form>
    ...
    <el-table :key='tableKey'
      ...
      <el-table-column align="center"
        ...
        <template scope="scope">
          <span v-if="scope.row.return_time == 0">长期</span>
          <span v-else>
            {{new Date((parseInt(scope.row.return_time) * 1000)) | parseTime('{y}-{m}-{d}')}}
          </span>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center"
                       label="">
        <template scope="scope">
          <div v-if="scope.row.good_img">
            <img :src="scope.row.good_img"
                 :alt="scope.row.good_name"
      ...
      <el-table-column align="center"
                       label="物品"
                       prop="good_name"></el-table-column>
  
      <el-table-column align="center"
                       label="流水号"
                       prop="order_no"></el-table-column>
  
      <el-table-column align="center"
                       label="固定资产编号"
                       prop="asset_sn"></el-table-column>
  
      <el-table-column align="center"
                       label="物品隶属"
                       prop="good_department"></el-table-column>
      ...
      <el-table-column align="center"
                       label="借用者电话"
                       prop="user_phone"></el-table-column>
